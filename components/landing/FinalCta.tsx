  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-zinc-200 bg-zinc-50 px-6 py-14 text-center dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-zinc-600 sm:text-base sm:leading-7 dark:text-zinc-400">
          Your journey is the interviewer. See where you stand before the real
          thing.
        </p>
        <Link
          href="/interview"
          className="mt-8 inline-flex min-h-[44px] items-center rounded-xl bg-indigo-600 px-7 py-3 text-sm font-semibold text-white shadow-sm shadow-indigo-600/25 transition-colors hover:bg-indigo-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/60"
        >
          Start Interview
        </Link>
      </div>
